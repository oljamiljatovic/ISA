...
insert into employee(id,name,surname,date_birth,conf_number,shoe_number,restaurant,first_log) values (6,'Zora','Milut','1967-04-23', 'L','38',1,'true')
INSERT INTO user(id,email,password,role,accept) VALUES(7,'sima','simasima','cook','true')
insert into employee(id,name,surname,date_birth,conf_number,shoe_number,restaurant,first_log) values (7,'Sinisa','Milut','1964-05-29', 'XL','46',1,'true')
INSERT INTO user(id,email,password,role,accept) VALUES(8,'dana','danadana','barman','true')
insert into employee(id,name,surname,date_birth,conf_number,shoe_number,restaurant,first_log) values (8,'Dana','Zivan','1972-01-29', 'L','39',1,'true')
INSERT INTO user(id,email,password,role,accept) VALUES(9,'gavra','gavragavra','waiter','true')
insert into employee(id,name,surname,date_birth,conf_number,shoe_number,restaurant,first_log) values (9,'Gavra','Zivan','1978-02-21', 'XL','44',1,'true')
